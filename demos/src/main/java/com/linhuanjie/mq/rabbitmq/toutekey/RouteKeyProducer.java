package com.linhuanjie.mq.rabbitmq.toutekey;
...
public class RouteKeyProducer {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        String message_insert = "发布订阅模式-RouteKey-Insert！";
        /**
         * 消息发送
        ...
        String message_update = "发布订阅模式-RouteKey-Update！";
