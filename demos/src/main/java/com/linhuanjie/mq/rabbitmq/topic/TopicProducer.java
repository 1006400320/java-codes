package com.linhuanjie.mq.rabbitmq.topic;

import com.linhuanjie.mq.rabbitmq.util.ConnectionUtil;
...
public class TopicProducer {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //消息-item.insert
        String message_insert = "发布订阅模式-Topic-item.insert:！";
        /**
         * 消息发送
        ...
        //消息-item.update
        String message_update = "发布订阅模式-Topic-item.update！";
        channel.basicPublish("topic_exchange", "item.update", null, message_update.getBytes());

        //消息-item.delete
        String message_delete = "发布订阅模式-Topic-item.delete！";
