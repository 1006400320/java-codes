...
public class FactoryMethod {
    public static void main(String[] args) {
        ...
        ExportFile exportWord = factory.factory(Constant.FACTORY_WORD.getCode());
        exportWord.export(data);
        factory = new ExportPdfFactory();
        ExportFile exportPdf = factory.factory(Constant.FACTORY_WORD.getCode());
...
class ExportWordFactory implements ExportFactory {
    ...
    public ExportFile factory(String type) {
        if (Constant.FACTORY_WORD.getCode().equals(type)) {
            return new ExportUserWordFile();
        } else if (Constant.FACTORY_WORD.getCode().equals(type)) {
