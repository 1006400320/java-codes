 ...
 * @author: linhuanjie
 * @description:
 *          VMOption: -Xms1024m -Xmx1024m -XX:+PrintGCDetails
 * @createTime : 2018-11-27 16:16
...
public class OutOfMemoryError {
    ...
    public static void printMemory()  {
        ...
        System.out.println("-Xmx:  maxMemory" + "：" + maxMemory + " KB，" + maxMemory/1024/1024 + " MB");
        System.out.println("-Xms:  totalMemory" + "：" + totalMemory + " KB，" + totalMemory/1024/1024 + " MB");
        System.out.println("cpu核数：availableProcessors：" + "：" + availableProcessors );
        System.out.println("freeMemory" + "：" + freeMemory + "KB，" + freeMemory/1024/1024 + "MB");
    }
     ...
     */
    @Test
    public void constantsPoolOutOfMemoryError() {
        long i = 0;
        String a = "";
