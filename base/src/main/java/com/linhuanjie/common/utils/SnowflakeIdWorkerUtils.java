...
public class SnowflakeIdWorkerUtils {
    ...
    /**
     * 构造函数
     * @param inWorkerId 工作ID (0~31)
     * @param inDatacenterId 数据中心ID (0~31)
     */
    public SnowflakeIdWorkerUtils(long inWorkerId, long inDatacenterId) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000; i++) {
            long id = SnowflakeIdWorkerUtils.nextId();
